  ...
  def getParser = {
    ...
    new scopt.OptionParser[CliConfig]( "jsvcgen-generate" ) {
      ...
      opt[Seq[String]]( "release" )
        .text( "List of Release Process levels to generate (i.e. Public, Incubate, Internal, ALL)." )
        .optional( )
      ...
      opt[String]( "value-types" )
        .text( "A JSON file specifying a list of type names to consider as value (struct) types." )
        .optional( )
        .action { ( x, c ) => c
